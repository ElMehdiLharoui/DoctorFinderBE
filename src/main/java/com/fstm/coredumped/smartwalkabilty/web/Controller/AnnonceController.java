...
public class AnnonceController extends HttpServlet {
    private AnnouncesService service = new AnnouncesService();
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            String s1 = service.createAnnounce(blob);
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            AnnonceBlob Blob = s.fromJson(req.getReader(), AnnonceBlob.class);
            String s1 = service.updateAnnounce(Blob);
            if (s1.contains("invalid")) resp.setStatus(400);
            resp.getWriter().println(s1);
        } catch (Exception e) {
            System.err.println(e);
    ...
    protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            String s1 = service.deleteAnnounce(Blob);
            if (s1.contains("invalid")) resp.setStatus(400);
            resp.getWriter().println(s1);
        } catch (Exception e) {
            System.err.println(e);
